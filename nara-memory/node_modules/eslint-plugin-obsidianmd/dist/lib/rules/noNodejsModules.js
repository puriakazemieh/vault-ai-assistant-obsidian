...
export default ruleCreator({
    ...
    meta: {
        ...
        schema: [],
        messages: {
            noNodejs: "Do not import Node.js built-in module \"{{module}}\". Node.js APIs are not available on mobile. Use a dynamic import() or require() guarded by Platform.isDesktop instead.",
        },
    },
    defaultOptions: [],
    create(context) {
...
function isPlatformIsDesktop(expr) {
    // Platform.isDesktop
...
function extractsPlatformIsDesktop(expr) {
...
function isGuardedByPlatformIsDesktop(node) {
    ...
    while (current) {
        ...
        else if (current.type === AST_NODE_TYPES.FunctionDeclaration ||
 ...
 */
function isEarlyExitGuard(ifStmt) {
...
function hasEarlyExit(stmt) {
    ...
    if (stmt.type === AST_NODE_TYPES.BlockStatement) {
        ...
        if (firstStmt && (firstStmt.type === AST_NODE_TYPES.ThrowStatement ||
 ...
 */
function hasGuardAtFunctionStart(func) {
